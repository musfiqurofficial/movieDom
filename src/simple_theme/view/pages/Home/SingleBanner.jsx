  ...
  return (
    <>
      ...
      <If isTrue={status === _STATUS.success}>
        <SingleBannerStyle bg={backdrop} className="d-flex align-items-center ps-0 px-md-3 ps-lg-5 ">
              ...
              <Col xs={12} md={8}>
                <div className="d-flex flex-column flex-md-row justify-content-center justify-content-md-start gap-3">
                  <div className="d-flex justify-content-center justify-content-md-start">
                    <Image src={poster} className="w-100 rounded-1 shadow-lg" style={{minWidth:'220px',maxWidth:'60vw',}} />
                  </div>
                  <div xs={12} md={9} className="d-flex flex-column align-items-center align-items-md-start  justify-content-center">
