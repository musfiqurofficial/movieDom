...
import MDomOverlaySlider from "./MDomSliders/MDomOverlaySlider";

const OverlaySlider = ({ last_slider = false, title, more, data = [] }) => {
  return (
    <div
      className={`py-10  ${
        USE_MOBILE_THEME_ONLY.value ? "" : "slider-section"
      }`}
    >
      <Container>
      ...
      <MDomOverlaySlider data={data} last_slider={last_slider} />
    </div>
  );
};
